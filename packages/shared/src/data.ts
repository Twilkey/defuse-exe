...
export const WEAPONS: WeaponDef[] = [
  // ── Starters ──
  { id: "plasma_pistol",  name: "Pencil Toss",    description: "Throws sharp pencil projectiles.",     pattern: "projectile", starter: true,  baseDamage: 10, baseCooldownMs: 600,  baseArea: 8,   baseProjectiles: 1, basePierce: 0, baseSpeed: 12, baseDuration: 60,  baseKnockback: 2,  maxLevel: 30, color: "#38bdf8", ascendedId: "supernova_cannon",  matchingTokenId: "solar_medal" },
  { id: "energy_blade",   name: "Eraser Slash",   description: "Wide erasing arc at close range.",     pattern: "area",       starter: true,  baseDamage: 15, baseCooldownMs: 450,  baseArea: 50,  baseProjectiles: 1, basePierce: 99,baseSpeed: 0,  baseDuration: 10,  baseKnockback: 3,  maxLevel: 30, color: "#f97316", ascendedId: "void_scythe",       matchingTokenId: "shadow_medal" },
  { id: "drone_swarm",    name: "Paper Planes",   description: "Orbiting paper planes deal contact damage.", pattern: "orbit",  starter: true,  baseDamage: 8,  baseCooldownMs: 200,  baseArea: 70,  baseProjectiles: 3, basePierce: 99,baseSpeed: 3,  baseDuration: 999, baseKnockback: 1,  maxLevel: 30, color: "#4ade80", ascendedId: "hivemind_swarm",    matchingTokenId: "hive_medal" },
  { id: "pulse_rifle",    name: "Pen Shooter",    description: "Rapid-fire pen ink shots.",             pattern: "projectile", starter: true,  baseDamage: 5,  baseCooldownMs: 200,  baseArea: 6,   baseProjectiles: 1, basePierce: 0, baseSpeed: 16, baseDuration: 40,  baseKnockback: 1,  maxLevel: 30, color: "#e879f9", ascendedId: "annihilator",       matchingTokenId: "overcharge_medal" },
  { id: "flame_emitter",  name: "Crayon Blast",   description: "Cone of colorful crayon streaks.",      pattern: "cone",       starter: true,  baseDamage: 7,  baseCooldownMs: 150,  baseArea: 60,  baseProjectiles: 3, basePierce: 99,baseSpeed: 8,  baseDuration: 15,  baseKnockback: 1,  maxLevel: 30, color: "#fbbf24", ascendedId: "inferno_storm",     matchingTokenId: "ember_medal" },

  // ── Regular (from level-ups) ──
  { id: "railgun",           name: "Ruler Beam",        description: "Piercing ruler beam punches through.",   pattern: "beam",       starter: false, baseDamage: 30, baseCooldownMs: 1200, baseArea: 10,  baseProjectiles: 1, basePierce: 5, baseSpeed: 40, baseDuration: 5,   baseKnockback: 6,  maxLevel: 30, color: "#67e8f9", ascendedId: "omega_railgun",     matchingTokenId: "precision_medal" },
  { id: "grenade_launcher",  name: "Ink Bomb",          description: "Lobbed ink blob that splatters.",        pattern: "projectile", starter: false, baseDamage: 25, baseCooldownMs: 1400, baseArea: 70,  baseProjectiles: 1, basePierce: 0, baseSpeed: 8,  baseDuration: 50,  baseKnockback: 8,  maxLevel: 30, color: "#a3e635", ascendedId: "cluster_nuke",      matchingTokenId: "blast_medal" },
  { id: "lightning_coil",    name: "Staple Chain",      description: "Staples chain between nearby enemies.",  pattern: "chain",      starter: false, baseDamage: 12, baseCooldownMs: 800,  baseArea: 120, baseProjectiles: 1, basePierce: 3, baseSpeed: 0,  baseDuration: 8,   baseKnockback: 2,  maxLevel: 30, color: "#c084fc", ascendedId: "storm_caller",      matchingTokenId: "storm_medal" },
  { id: "frost_ring",        name: "Whiteout Ring",     description: "Expanding ring of correction fluid.",   pattern: "ring",       starter: false, baseDamage: 8,  baseCooldownMs: 2000, baseArea: 150, baseProjectiles: 1, basePierce: 99,baseSpeed: 4,  baseDuration: 40,  baseKnockback: 0,  maxLevel: 30, color: "#22d3ee", ascendedId: "absolute_zero",     matchingTokenId: "cryo_medal" },
  { id: "toxic_sprayer",     name: "Glue Puddle",       description: "Leaves sticky glue on the ground.",      pattern: "ground",     starter: false, baseDamage: 6,  baseCooldownMs: 1000, baseArea: 45,  baseProjectiles: 1, basePierce: 99,baseSpeed: 0,  baseDuration: 80,  baseKnockback: 0,  maxLevel: 30, color: "#86efac", ascendedId: "plague_engine",     matchingTokenId: "blight_medal" },
  { id: "homing_rockets",    name: "Dart Seekers",      description: "Homing darts find nearest targets.",     pattern: "homing",     starter: false, baseDamage: 18, baseCooldownMs: 900,  baseArea: 30,  baseProjectiles: 2, basePierce: 0, baseSpeed: 7,  baseDuration: 80,  baseKnockback: 4,  maxLevel: 30, color: "#fb7185" },
  { id: "boomerang_disc",    name: "Compass Spin",      description: "Spinning compass that returns.",         pattern: "projectile", starter: false, baseDamage: 14, baseCooldownMs: 1100, baseArea: 12,  baseProjectiles: 1, basePierce: 4, baseSpeed: 10, baseDuration: 60,  baseKnockback: 3,  maxLevel: 30, color: "#fde68a" },
  { id: "shockwave_stamp",   name: "Stamp Slam",        description: "AoE stamp blast centered on you.",       pattern: "area",       starter: false, baseDamage: 20, baseCooldownMs: 1500, baseArea: 90,  baseProjectiles: 1, basePierce: 99,baseSpeed: 0,  baseDuration: 8,   baseKnockback: 10, maxLevel: 30, color: "#fca5a5" },
  { id: "laser_drill",       name: "Highlighter",       description: "Continuous highlight beam to nearest.",  pattern: "beam",       starter: false, baseDamage: 4,  baseCooldownMs: 100,  baseArea: 8,   baseProjectiles: 1, basePierce: 0, baseSpeed: 50, baseDuration: 3,   baseKnockback: 0,  maxLevel: 30, color: "#fcd34d" },
  { id: "mine_deployer",     name: "Tack Trap",         description: "Drops thumbtack mines behind you.",      pattern: "ground",     starter: false, baseDamage: 35, baseCooldownMs: 1600, baseArea: 55,  baseProjectiles: 1, basePierce: 0, baseSpeed: 0,  baseDuration: 200, baseKnockback: 5,  maxLevel: 30, color: "#94a3b8" },
];
...
export const ASCENSION_RECIPES: AscensionRecipe[] = [
  { weaponId: "plasma_pistol",    tokenId: "solar_medal",      ascendedWeaponId: "supernova_cannon", requiredWeaponLevel: 10 },
  { weaponId: "energy_blade",     tokenId: "shadow_medal",     ascendedWeaponId: "void_scythe",      requiredWeaponLevel: 10 },
  { weaponId: "drone_swarm",      tokenId: "hive_medal",       ascendedWeaponId: "hivemind_swarm",   requiredWeaponLevel: 10 },
  { weaponId: "pulse_rifle",      tokenId: "overcharge_medal", ascendedWeaponId: "annihilator",      requiredWeaponLevel: 10 },
  { weaponId: "flame_emitter",    tokenId: "ember_medal",      ascendedWeaponId: "inferno_storm",    requiredWeaponLevel: 10 },
  { weaponId: "railgun",          tokenId: "precision_medal",  ascendedWeaponId: "omega_railgun",    requiredWeaponLevel: 10 },
  { weaponId: "grenade_launcher", tokenId: "blast_medal",      ascendedWeaponId: "cluster_nuke",     requiredWeaponLevel: 10 },
  { weaponId: "lightning_coil",   tokenId: "storm_medal",      ascendedWeaponId: "storm_caller",     requiredWeaponLevel: 10 },
  { weaponId: "frost_ring",       tokenId: "cryo_medal",       ascendedWeaponId: "absolute_zero",    requiredWeaponLevel: 10 },
  { weaponId: "toxic_sprayer",    tokenId: "blight_medal",     ascendedWeaponId: "plague_engine",    requiredWeaponLevel: 10 },
];
...
export const ENEMIES: EnemyDef[] = [
  // Melee
  { id: "crawler",     name: "Scribble",        enemyClass: "melee",  baseHp: 15,  baseDamage: 8,   baseSpeed: 3.6, xpValue: 2,   size: 16, color: "#ef4444", shape: "circle",   visual: "male",   spawnWeight: 10, minWave: 1 },
  { id: "charger",     name: "Doodle Bull",     enemyClass: "melee",  baseHp: 20,  baseDamage: 12,  baseSpeed: 6.0, xpValue: 4,   size: 20, color: "#f97316", shape: "triangle", visual: "beast",  spawnWeight: 6,  minWave: 1 },
  { id: "brute",       name: "Ink Blob",        enemyClass: "melee",  baseHp: 60,  baseDamage: 20,  baseSpeed: 2.8, xpValue: 8,   size: 28, color: "#991b1b", shape: "circle",   visual: "slime",  spawnWeight: 3,  minWave: 1 },
  { id: "swarmer",     name: "Dot",             enemyClass: "melee",  baseHp: 5,   baseDamage: 3,   baseSpeed: 5.5, xpValue: 1,   size: 10, color: "#fda4af", shape: "circle",   visual: "spider", spawnWeight: 15, minWave: 1 },
  // Ranged
  { id: "spitter",     name: "Sketch Archer",   enemyClass: "ranged", baseHp: 12,  baseDamage: 10,  baseSpeed: 3.0, xpValue: 3,   size: 17, color: "#22c55e", shape: "diamond",  visual: "female", spawnWeight: 5,  minWave: 1 },
  { id: "sniper",      name: "Fine Liner",      enemyClass: "ranged", baseHp: 10,  baseDamage: 18,  baseSpeed: 2.4, xpValue: 5,   size: 15, color: "#a855f7", shape: "diamond",  visual: "bird",   spawnWeight: 3,  minWave: 1 },
  { id: "turret",      name: "Pencil Tower",    enemyClass: "ranged", baseHp: 35,  baseDamage: 6,   baseSpeed: 0.0, xpValue: 6,   size: 22, color: "#6b7280", shape: "square",   visual: "robot",  spawnWeight: 2,  minWave: 1 },
  // Casters
  { id: "warper",      name: "Smudge",          enemyClass: "caster", baseHp: 18,  baseDamage: 14,  baseSpeed: 3.2, xpValue: 5,   size: 18, color: "#3b82f6", shape: "hexagon",  visual: "ghost",  spawnWeight: 3,  minWave: 1 },
  { id: "necromancer", name: "Dark Pen",        enemyClass: "caster", baseHp: 25,  baseDamage: 5,   baseSpeed: 2.4, xpValue: 8,   size: 20, color: "#581c87", shape: "hexagon",  visual: "demon",  spawnWeight: 2,  minWave: 1,  abilities: ["summon"] },
  { id: "shaman",      name: "Marker Spirit",   enemyClass: "caster", baseHp: 20,  baseDamage: 8,   baseSpeed: 2.6, xpValue: 6,   size: 18, color: "#14b8a6", shape: "diamond",  visual: "snake",  spawnWeight: 2,  minWave: 1, abilities: ["buff_aura"] },
  // Mini-bosses (spawned by timer, not waves)
  { id: "siege_titan", name: "Giant Doodle",    enemyClass: "melee",  baseHp: 300, baseDamage: 25,  baseSpeed: 1.8, xpValue: 80,  size: 38, color: "#b91c1c", shape: "circle",   visual: "demon",  spawnWeight: 0,  minWave: 99, abilities: ["ground_slam", "charge", "summon_minions"] },
  { id: "storm_witch", name: "Chaos Scribble",  enemyClass: "caster", baseHp: 200, baseDamage: 18,  baseSpeed: 3.0, xpValue: 80,  size: 32, color: "#7c3aed", shape: "hexagon",  visual: "female", spawnWeight: 0,  minWave: 99, abilities: ["spread_shot", "vortex", "teleport"] },
  { id: "hive_queen",  name: "Ink Mother",      enemyClass: "caster", baseHp: 250, baseDamage: 12,  baseSpeed: 2.2, xpValue: 80,  size: 34, color: "#15803d", shape: "hexagon",  visual: "spider", spawnWeight: 0,  minWave: 99, abilities: ["spawn_swarm", "poison_aura"] },
  // Bosses (spawned by timer)
  { id: "detonator",   name: "The Eraser",      enemyClass: "melee",  baseHp: 2000,baseDamage: 30,  baseSpeed: 1.6, xpValue: 500, size: 60, color: "#dc2626", shape: "circle",   visual: "demon",  spawnWeight: 0,  minWave: 99, abilities: ["carpet_bomb", "laser_sweep", "spawn_turrets", "enrage"] },
  { id: "void_archon", name: "The Shredder",    enemyClass: "caster", baseHp: 2500,baseDamage: 28,  baseSpeed: 2.2, xpValue: 600, size: 58, color: "#6d28d9", shape: "hexagon",  visual: "ghost",  spawnWeight: 0,  minWave: 99, abilities: ["gravity_well", "clone_split", "dark_nova", "teleport"] },
];
